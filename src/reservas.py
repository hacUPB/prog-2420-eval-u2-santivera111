...
#Preguntar por asiento
    ...
    print(f"{titulo}{nombre}{apellido} Origen:{origen} Destino:{destino}, en la fecha:{dia_semana}{dia_mes} con un precio de {precio} y su asiento sera: {asiento}{asiento_numero}")
